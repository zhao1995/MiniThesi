...
c--------------------------------------------------------------------
     ...
     1           0, 0,27,38/
      ...
      data yt /
     1       0.299,0.232,0.166,0.099,0.079,0.032,
     2       0.299,0.232,0.166,0.099,0.079,0.032,
     3       0.332,0.280,0.228,0.175,0.150,0.120,
     4       0.332,0.280,0.228,0.175,0.150,0.120/
...
c.... write text on screen
      call drawtxt(1,xt(idev),yt(1,idev),2,1,63,
     1'A  F i n i t e  E l e m e n t   A n a l y s i s   P r o g r a m')
c
      call drawtxt(1,xt(idev),yt(2,idev),2,1,63,
     1'          (C)   R. L. T A Y L O R   1 9 8 4 - 2 0 1 2          ')
c
      call drawtxt(1,xt(idev),yt(3,idev),2,1,63,
     1'U n i v e r s i t y  o f  C a l i f o r n i a,  B e r k e l e y')
c
      call drawtxt(1,xt(idev),yt(4,idev),1,1,63,
cww  1'            Parallel Version: (C) W. Wagner                    ')
     1'(C) Institut f. Baustatik  Karlsruhe Institute of Technology   ')
c
      call drawtxt(1,xt(idev),yt(5,idev),1,1,63,
csk  1'            Isogeometric Version:                     ')
     1'(C) Lehrstuhl Baustatik und Baudynamik, RWTH Aachen')
c
      write(yy,2000) versn(1),versn(2)
      call drawtxt(1,xt(idev),yt(6,idev),1,1,63,yy)
