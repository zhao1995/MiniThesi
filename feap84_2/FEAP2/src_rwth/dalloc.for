...
c.... isogeo
      ...
      call rdealloc(AInstre   ,ldummy)
      call idealloc(AInoix    ,ldummy)
      call idealloc(AInRupdinit,ldummy)
      call rdealloc(AInpro    ,ldummy)
      call rdealloc(AInkv1    ,ldummy)
      call rdealloc(AInkv2    ,ldummy)
      call rdealloc(AImdirP   ,ldummy)
      call rdealloc(AInbasissys,ldummy)
