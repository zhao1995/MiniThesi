      ...
      logical          quad, ttfl, nurbfl, bsplfl, tsplfl, bezifl
      common /qudshpa/ quad, ttfl, nurbfl, bsplfl, tsplfl, bezifl

      logical          bnurfl, hsplfl
      common /qudshpa/ bnurfl, hsplfl
      ...
      real*8           hsize   ,hksize   ,xx0
      common /qudhsiz/ hsize(2),hksize(2),xx0(3)
