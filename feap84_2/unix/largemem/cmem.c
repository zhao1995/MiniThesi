 ...
 *                 Version for use when FORTRAN integers are 64bit
 *
 ...
 *   3. Convert to long version for 64bit integers       27-04-2011
 *-----[--.----+----.----+----.----------------------------------------]
 */
...
unsigned long compute_crc32(byte* buf, long len);
...
static offset_t allocfn(byte* base, long len, int atomlen)
/*
 *-------------------------------------------------------
...
/* GCC, INTEL, SUN and DEC use :
*/
void fallocfn_(offset_t* offset, long* len, int* precis, int* ipr)
/*
 *-------------------------------------------------------
...
/* GCC, INTEL, SUN and DEC use :
*/
void freallocfn_(offset_t* offset, long* len, int* precis, int* ipr)
/*
 *-------------------------------------------------------
