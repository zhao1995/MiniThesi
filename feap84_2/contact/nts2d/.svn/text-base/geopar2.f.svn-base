c$Id:$
      subroutine geopar2 (ndm,ndf,x,u,nel1,nod1,ix1,ix2,cxs,nc,
     &                    id,ch1,ch2,ch3)
...
c       1. Remove 'cp0' from routine -- unused              27/04/2007
c       2. Correct computation of 'csi' and 'gt'            08/03/2013
c-----[--.----+----.----+----.-----------------------------------------]
...
c       If gn not 0.0d0 compute new sin and cos
