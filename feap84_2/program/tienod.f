...
c       1. Add 'ipj' and revise check on node replacement   30/12/2012
c-----[--.----+----.----+----.-----------------------------------------]
...
c                       +d direction of coordinate
c                       -1 region search
c                       -2 material search
c                       -3 coordinate search
...
c-----[--.----+----.----+----.-----------------------------------------]
      ...
      integer   i1,j1,k1,k2,ni,nn,nm,n1,n2,r1,r2,list,nbuck, ipj
...
c             Check for other nodes that need to be changed
