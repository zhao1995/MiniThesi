c$Id:$
      subroutine apfuncs(x,v,val,nex,error)
...
c-----[--.----+----.----+----.-----------------------------------------]
c      Purpose: Evaluate expressions with functions in input records
c               for:   inc,   dec,
...
c         Functions 14 to 22
        ...
        i = i + 1
      if(i.lt.125) go to 140

c     Final evaluation of expression

      call aevalex(yy,v,val,k,error)
