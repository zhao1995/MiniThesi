...
c       1. Change 'Macro' to 'Command' in format            07/01/2008
c-----[--.----+----.----+----.-----------------------------------------]
...
2000  format(' No. Command Option',9x,'value-1     value-2     value-3')
...
3002  format(5x,'Currently history list contains',i4,' items.'/
     ...
     &    16x,'hist,add        - add new commands to list'/
     &    16x,'hist,noad       - do not add commands to list'/
