c$Id:$
      subroutine adcheck(x,vd,nt,error)
...
c       1. Adjust character length of 'y' to 425            21/12/2008
c-----[--.----+----.----+----.-----------------------------------------]
...
c     Expression substitution using predefined constants
      ...
      call acheck(x,y,n0,nt,425)
      call pcharr(y,ivd,n0,nn*n0)
      error = .false.
      read(y,'(17f25.0)',err=200) (vd(i),i=1,nn)
      do i = 1,nn
...
c     Error
 ...
 200  write(ilg,3000) nn,y(1:nn*25)
      write(iow,3000) nn,y(1:nn*25)
      if(ior.lt.0) then
        write(  *,3000) nn,y(1:nn*25)
      endif
      call errclr('INPUTS')
      error = .true.
