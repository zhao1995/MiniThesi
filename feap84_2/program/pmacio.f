...
c       1. Change print from 'Macro' to 'Command'           07/01/2008
c       2. Change clab to clab(1) in 2 places               09/01/2008
c       3. Dimension svd(1) for call to tinput              01/05/2012
c-----[--.----+----.----+----.-----------------------------------------]
c      Purpose: Solution command instructions input subprogram
